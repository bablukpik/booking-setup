...
const menuItems = [
  {
    icon: '/business-assets/icons/home.svg',
    label: 'Home',
    href: '#',
    id: 'home',
  },
  {
    ...
    subItems: [
      {
        icon: '/business-assets/icons/products.svg',
        label: 'Products',
        href: '#',
        id: 'sell-products',
      },
      {
        icon: '/business-assets/icons/experiences.svg',
        label: 'Experiences',
        href: '#',
        id: 'sell-experiences',
      },
      {
        icon: '/business-assets/icons/services.svg',
        label: 'Services',
        href: '#',
        id: 'sell-services',
      },
      {
        icon: '/business-assets/icons/bookings.svg',
        label: 'Bookings',
        href: '#',
        id: 'sell-bookings',
      },
      {
        icon: '/business-assets/icons/memberships.svg',
        label: 'Memberships',
        href: '#',
        id: 'sell-memberships',
      },
      {
        icon: '/business-assets/icons/bundles.svg',
        label: 'Bundles',
        href: '#',
        id: 'sell-bundles',
      },
      {
        icon: '/business-assets/icons/custom-offers.svg',
        label: 'Custom offers',
        href: '#',
        id: 'sell-custom-offers',
      },
    ],
  },
  {
    icon: '/business-assets/icons/customers.svg',
    label: 'Customers',
    href: '#',
    hasCollapse: true,
    id: 'customers',
  ...
  {
    icon: '/business-assets/icons/payouts.svg',
    label: 'Payouts',
    href: '#',
    hasCollapse: true,
    id: 'payouts',
  ...
  {
    icon: '/business-assets/icons/analytics.svg',
    label: 'Analytics',
    href: '#',
    id: 'analytics',
  },
  ...
  return (
    <div className="max-w-[281px] bg-[#f9fafc] border-r border-border flex flex-col h-screen overflow-y-auto border-box">
        ...
        {menuItems.map((item, index) => {
            ...
            return (
              <div key={item.id} className="mb-[15px]">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${openSell ? 'rotate-180' : ''}`}
                  />
                </button>
                {openSell && (
                  <div className="mt-1">
                    {item.subItems.map((subItem, subIndex) => {
                      ...
                      return (
                        <button
                          ...
                          className={`mb-[15px] w-full flex items-center justify-between pl-8 px-3 py-2 rounded-4xl transition-colors cursor-pointer ${
                            isSelected
          ...
          return (
            <button
              ...
              className={`mb-[15px] w-full flex items-center justify-between px-3 py-2 rounded-4xl transition-colors cursor-pointer ${
                isSelected
                  ? 'bg-[#E8F5FF] text-[#072AC8]'
                  : 'text-foreground hover:bg-accent hover:text-accent-foreground'
              }`}
      ...
      <div className="border-t border-border p-2 space-y-1">
        <button
          type="button"
          className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-foreground hover:bg-accent hover:text-accent-foreground transition-colors cursor-pointer"
        >
          <Icon
            icon="/business-assets/icons/settings.svg"
            alt="Settings"
            className="h-5 w-5"
          />
        ...
        >
          <Icon
            icon="/business-assets/icons/signout.svg"
            alt="Sign out"
            className="h-5 w-5"
          />
